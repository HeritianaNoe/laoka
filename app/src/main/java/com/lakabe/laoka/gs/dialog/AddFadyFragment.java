...
public class AddFadyFragment extends AppCompatDialogFragment {

    private EditText editText;
    private static FadyListener listener;

    public AddFadyFragment() {
        // Required empty public constructor
    }

    public static AddFadyFragment getInstance(FadyListener l) {
        listener = l;
        AddFadyFragment fragment = new AddFadyFragment();
        ...
        builder.setPositiveButton("Eny", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                if(list.length == 1){
                    ...
                    if(!s.isEmpty())
                        listener.onInsert(f, 0, view);
                }
                else{
                    Toast.makeText(requireContext(), "Ataovy teny tokana azafady!", Toast.LENGTH_SHORT).show();
                }
